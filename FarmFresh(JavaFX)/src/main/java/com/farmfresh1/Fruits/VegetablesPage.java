...
public class VegetablesPage {
     ...
     BeansSubPage objbeanssubpage=new BeansSubPage();

   
    public static void startVegetablesPage(Stage primaryStage) throws Exception {
            ...
            Image image11=new Image("file:imagedemofarmfresh\\src\\main\\resources\\Tomato.jpg");
            ImageView I11=new ImageView(image11);
            I11.setFitHeight(180);
            I11.setFitWidth(250);
            Label L11=new Label("Tomato");
            ...
            Image image12=new Image("file:imagedemofarmfresh\\src\\main\\resources\\dodka.jpeg");
            ImageView I12=new ImageView(image12);
            I12.setFitHeight(180);
            I12.setFitWidth(250);
            Label L12=new Label("Ridge-Gourd");
